...
def dashboard_page():
    ...
    for feature in choropleth.geojson.data['features']:
        ...
        feature['properties']['KMeans Label'] = 'Cluster: ' + str(df_indexed.loc[state_name, 'KMeans Label']) if state_name in df_indexed.index else ''

    choropleth.geojson.add_child(
        folium.features.GeoJsonTooltip(['state', 'KMeans Label'], labels=False)
    )
